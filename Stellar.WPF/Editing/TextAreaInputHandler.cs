...
{
    readonly SimpleObservableCollection<CommandBinding> commandBindings;
    readonly SimpleObservableCollection<InputBinding> inputBindings;
    readonly SimpleObservableCollection<ITextAreaInputHandler> nestedInputHandlers;
    readonly TextArea textArea;
    bool isAttached;
    ...
    {
        this.textArea = textArea ?? throw new ArgumentNullException(nameof(textArea));
        commandBindings = new SimpleObservableCollection<CommandBinding>(CommandBinding_Added, CommandBinding_Removed);
        inputBindings = new SimpleObservableCollection<InputBinding>(InputBinding_Added, InputBinding_Removed);
        nestedInputHandlers = new SimpleObservableCollection<ITextAreaInputHandler>(NestedInputHandler_Added, NestedInputHandler_Removed);
    }
